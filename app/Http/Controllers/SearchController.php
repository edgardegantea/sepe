...
class SearchController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:searchs.index');
    }
    /**
    ...
    public function create($id)
    {
        ...
        return view('searchs.create', compact('projects'));
    }
    ...
    {
        $evaluacion = Search::where('project_id', $search->project_id)->get();
        return view('searchs.edit', compact('search', 'evaluacion'));
    }
