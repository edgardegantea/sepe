...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-3">
                    <a href="{{route('projects.show', $rotulado->project_id)}}" class="btn btn-danger float-right">
                        Regresar</a>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" name="" action="{{route('rotulados.update', $rotulado->project_id)}}">
                @csrf
                @method('PUT')
                ...
                <input type="hidden" name="id_project" value="{{$rotulado->project_id}}">
