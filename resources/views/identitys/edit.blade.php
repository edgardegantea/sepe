...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-9">
                    <p>Elementos relacionados con la identidad del sitio, la información proporcionada sobre el
                        proveedor y la autoría de los contenidos.</p>
                </div>
                <div class="col-3">
                    <a href="{{route('projects.show', $identity->project_id)}}" class="btn btn-danger float-right">
                        Regresar</a>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" name="" action="{{route('identitys.update', $identity->project_id)}}">
                @csrf
                @method('PUT')
                ...
                <input type="hidden" name="id_project" value="{{$identity->project_id}}">
