...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-3">
                    <a href="{{route('projects.show', $layoutpage->project_id)}}" class="btn btn-danger float-right">
                        Regresar</a>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" name="" action="{{route('layoutpages.update', $layoutpage->project_id)}}">
                @csrf
                @method('PUT')
                ...
                <input type="hidden" name="id_project" value="{{$layoutpage->project_id}}">
